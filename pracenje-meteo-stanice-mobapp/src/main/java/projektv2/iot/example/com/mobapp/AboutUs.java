/*
 * Created by Mikaela on 03/6/2018.
 */
...
public class AboutUs extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.nav_home:
                Intent h = new Intent(AboutUs.this,Home.class);
                startActivity(h);
                break;
            case R.id.nav_temp:
                Intent t = new Intent(AboutUs.this,Temperatura.class);
                startActivity(t);
                break;
            case R.id.nav_tlak:
                Intent p = new Intent(AboutUs.this,Tlak.class);
                startActivity(p);
                break;
            case R.id.nav_info:
